...
<body>
    ...
    <audio src="audio/sonidoSecreto2.mp3" preload="auto" id="sonidosecreto"></audio>
    <main>
        <nav class="icons">
        ...
        <div>
            ...
            <form id="formularioLoginUser">
                ...
                <input type="submit" class="boton" value="Iniciar sesión" disabled id="iniciarSesion">
                <p>¿No tienes cuenta? <a href="index.php?c=Usuarios&m=mostrarRegistrar">REGÍSTRATE</a></p>
            </form>
            <div class="alcaldes">
                <div id="ss"><img src="img/alcalde1.png" alt=""></div>
