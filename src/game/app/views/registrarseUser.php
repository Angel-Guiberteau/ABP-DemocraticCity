    ...
    <main>
        ...
        <div>
            ...
            <form id="formularioRegistro">
                ...
                <input type="text" id="nombre" placeholder="Nombre de usuario" name="usuario">
                ...
                <input type="submit" class="boton" value="Registrarse" id="registroUser" disabled>
                <p>¿Ya tienes cuenta? <a href="index.php?c=Usuarios&m=predeterminada">INICIA SESIÓN</a> </p>
            </form>
